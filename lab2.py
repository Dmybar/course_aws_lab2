...
bucket_name = 'lookil-bucket-lab2'
...
df1['exchangedate'] = pd.to_datetime(df1['exchangedate'],infer_datetime_format=True)
df2['exchangedate'] = pd.to_datetime(df2['exchangedate'],infer_datetime_format=True)
